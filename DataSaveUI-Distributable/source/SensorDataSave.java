...
public class SensorDataSave extends PApplet {
...
int rectColor, circleColor; // Base colors for shapes 
int rectHighlight, circleHighlight; // Highlighted colors for shapes
int regaliaPurple, calhounGreen; // Background colors
int currentColor;
...
public void setup()
{
  ...
  surface.setTitle("CU-ICAR Sensor Glove Data Collection"); // Set title bar
   // Set window size
  background(0xff86898C); // Innovation Grey // Set background color of boot screen
  ...
  // Shape color setup
  rectColor = color(0xff000000); // Set color of rectangle
  rectHighlight = color(0xff86898C); // Innovation Grey // Set highlighted color of rectangle
  circleColor = color(0xffF66733); // Clemson Orange // Set color of circle
  circleHighlight = color(0xffA25016); // Tillman Brick // Set highlighted color of circle
  regaliaPurple = color(0xff522D80); //Regalia Purple
  calhounGreen = color(0xffB5C327); //Calhoun Fields Green
...
public void folderSelected(File saveLocation) {
...
public boolean overCircle(int x, int y, int diameter) {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "SensorDataSave" };
    if (passedArgs != null) {

...
public class DataLabelingUI extends PApplet {

  // Import button handling library
...
int bengalStripe, innovationGrey, clemsonOrange, tillmanBrick, regaliaPurple, calhounGreen; // Create color objects
...
public void setup() {
  ...
  // Set color objects 
  bengalStripe = color(0xff000000); // Set color of rectangle
  innovationGrey = color(0xff86898C); // Innovation Grey // Set highlighted color of rectangle
  clemsonOrange = color(0xffF66733); // Clemson Orange // Set color of circle
  tillmanBrick = color(0xffA25016); // Tillman Brick // Set highlighted color of circle
...
public void folderSelected(File saveLocation) { // Check for and set folder location by user input
...
if(saveLocSet == true){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "DataLabelingUI" };
    if (passedArgs != null) {
